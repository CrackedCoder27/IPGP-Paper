...
\usepackage{enumitem}
\usepackage{xr}
\externaldocument{supplimentary}
\setlength{\textfloatsep}{5pt}
\setlength{\intextsep}{5pt}
\captionsetup[figure]{font=scriptsize} % Options: small, footnotesize, scriptsize
\linenumbers
%%%%%%%
...
%\authors{\authors{Baibhab Karmakar\affil{1}},Martin Vallée\affil{2}}
\authors{Baibhab Karmakar\affil{1}, Martin Vallée\affil{2}}
...
\affiliation{1}{Indian Institute of Science Education and Research Kolkata,
Mohanpur, West Bengal, India}
\affiliation{2}{Université Paris Cité, Institut de physique du globe de Paris, CNRS, Paris, France }
...
\correspondingauthor{Baibhab Karmakar}{bk22ms064@iiserkol.ac.in}
...
\begin{keypoints}
\item RSTF 
\item Source Inversion using RSTF and Teleseismic data
\item Compare slip models from RSTF and Teleseismic data
\end{keypoints}
...
\newpage
\input{sections/data_method.tex}
\newpage
...
% The included section files can leave an itemize environment open when the
% main document is finalized. Close it here to avoid ending the document while
% a list is still active.
\end{itemize}
