...
\begin{itemize}
    ...
    from the GEOSCOPE database from the networks: IU, II, GT, G, GE, DK, CN.
    ...
    and 7 s. The waveforms were processed using low- and broadband smoothing periods of 33 and 8 s, respectively, and a high-frequency 
    cutoff of 0.005 Hz was applied.
\end{itemize}
